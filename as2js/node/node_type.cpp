...
type_name_t const g_node_type_name[] =
{
    ...
    NODE_TYPE_NAME(ATAN),
    NODE_TYPE_NAME(ATAN2),
    NODE_TYPE_NAME(ATANH),
    ...
    NODE_TYPE_NAME(FLOOR),
    NODE_TYPE_NAME(FOR),
    NODE_TYPE_NAME(FROUND),
    NODE_TYPE_NAME(FUNCTION),
    NODE_TYPE_NAME(GOTO),
    NODE_TYPE_NAME(GREATER_EQUAL),
    NODE_TYPE_NAME(HYPOT),
    NODE_TYPE_NAME(IDENTIFIER),
    NODE_TYPE_NAME(IDENTITY),
    NODE_TYPE_NAME(IF),
    NODE_TYPE_NAME(IF_FALSE),
    NODE_TYPE_NAME(IF_TRUE),
    ...
    NODE_TYPE_NAME(LIST),
    NODE_TYPE_NAME(LOG),
    NODE_TYPE_NAME(LOG10),
    NODE_TYPE_NAME(LOG1P),
    NODE_TYPE_NAME(LOG2),
