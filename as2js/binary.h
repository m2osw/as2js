...
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_CONCAT_PARAMS     = 8;        // void strings_concat_params(binary_variable *,binary_variable const *,binary_variable const *)
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_UNCONCAT          = 9;        // void strings_unconcat(binary_variable *,binary_variable const *,binary_variable const *)
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_SHIFT             = 10;       // void strings_shift(binary_variable *,int64_t,node_t)
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_FLIP_CASE         = 11;       // void strings_flip_case(binary_variable *,binary_variable *)
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_MULTIPLY          = 12;       // void strings_multiply(binary_variable *,binary_variable *,int64_t)
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_MINMAX            = 13;       // void strings_minmax(binary_variable *,binary_variable *,binary_variable *,int8_t)
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_AT                = 14;       // void strings_at(binary_variable *,binary_variable *,int64_t)
...
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_TO_LOWERCASE      = 24;       // void strings_to_lowercase(binary_variable *,binary_variable *)
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_TO_UPPERCASE      = 25;       // void strings_to_uppercase(binary_variable *,binary_variable *)
...
constexpr external_function_t const     EXTERNAL_FUNCTION_FLOATING_POINTS_TO_STRING = 31;   // void floating_points_to_string(binary_variable *,double)
constexpr external_function_t const     EXTERNAL_FUNCTION_ARRAY_INITIALIZE          = 32;       // void array_initialize(binary_variable *)
constexpr external_function_t const     EXTERNAL_FUNCTION_ARRAY_FREE                = 33;       // void array_free(binary_variable *)
constexpr external_function_t const     EXTERNAL_FUNCTION_ARRAY_PUSH                = 34;       // void array_push(binary_variable *,binary_variable *)
