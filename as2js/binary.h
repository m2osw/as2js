...
constexpr external_function_t const     EXTERNAL_FUNCTION_STRINGS_CHAR_CODE_AT = 16;       // void strings_char_code_at(binary_variable *,binary_variable *,binary_variable *)
constexpr external_function_t const     EXTERNAL_FUNCTION_ARRAY_INITIALIZE     = 17;       // void array_initialize(binary_variable *)
constexpr external_function_t const     EXTERNAL_FUNCTION_ARRAY_FREE           = 18;       // void array_free(binary_variable *)
constexpr external_function_t const     EXTERNAL_FUNCTION_ARRAY_PUSH           = 19;       // void array_push(binary_variable *,binary_variable *)
